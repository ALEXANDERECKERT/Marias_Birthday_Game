controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    if (projectile.y < 0) {
        if (x == 0) {
            ...
            textSprite = textsprite.create("Cake Time Crush!")
            projectile = sprites.createProjectileFromSprite(img`
                ...
                `, mySprite, 0, -50)
            x += 1
            textSprite.setPosition(78, 49)
        } else if (x == 1) {
            music.play(music.melodyPlayable(music.pewPew), music.PlaybackMode.InBackground)
            sprites.destroy(textSprite)
            textSprite = textsprite.create("Pizza In Your Face!")
            projectile = sprites.createProjectileFromSprite(img`
                . . . . . . b b b b . . . . . . 
                . . . . . . b 4 4 4 b . . . . . 
                . . . . . . b b 4 4 4 b . . . . 
            ...
            music.play(music.melodyPlayable(music.pewPew), music.PlaybackMode.InBackground)
            sprites.destroy(textSprite)
            textSprite = textsprite.create("Ice Cream Smash!")
            projectile = sprites.createProjectileFromSprite(img`
                . . . . . 3 3 b 3 3 d d 3 3 . . 
            ...
            music.play(music.melodyPlayable(music.pewPew), music.PlaybackMode.InBackground)
            sprites.destroy(textSprite)
            textSprite = textsprite.create("Stuff a ham in it!")
            projectile = sprites.createProjectileFromSprite(img`
                . . . . . . 2 2 2 2 . . . . . . 
                . . . . 2 2 3 3 3 3 2 e . . . . 
                . . . 2 3 d 1 1 d d 3 2 e . . . 
...
for (let index = 0; index < 10; index++) {
    ...
    if (z == 1) {
        mySprite2 = sprites.create(img`
            ...
            ........................
            `, SpriteKind.Enemy)
        mySprite2.setVelocity(randint(30, 95), randint(0, 10))
...
forever(function () {
    if (y >= 10) {
        sprites.destroy(textSprite)
        textSprite = textsprite.create("Happy Birthday Maria!")
        textSprite.setPosition(78, 49)
    }
})
